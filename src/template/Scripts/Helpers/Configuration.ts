...
/** @const */
export var _TransEndEventNames = {
...
export var TransitionName: string = _TransEndNames[<any>Modernizr.prefixed('transition')];

export var TransitionEnd: string = _TransEndEventNames[<any>Modernizr.prefixed('transition')];
